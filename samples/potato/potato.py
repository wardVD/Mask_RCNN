"""
Mask R-CNN
Train on the toy Potato dataset and implement color splash effect.
...
class PotatoDataset(utils.Dataset):
    ...
    def load_potato(self, dataset_dir, subset):
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "dewulf_potato_harvester.json")))
